...
from employees.models import EmployeePerformance
...
def seed_data():
    ...
    dept, _ = Department.objects.get_or_create(
        ...
        defaults={
            "description": "IT & Software Development Department",
            "is_active": True,
        },
    )
    ...
    sample_reports = [
        (
            ...
            today,
            "Submitted full feature integration.",
            "Completed UI overhaul and login views.",
            "SUBMITTED",
        ),
        (
            ...
            "Worked on candidate module API.",
    ...
    sample_notifications = [
        (
            ...
            "Please submit your weekly work report before Friday 5 PM.",
            "REPORT_REMINDER",
        ),
        (
            "HR Feedback",
            "Your report for Week 3 has been reviewed by HR Manager.",
            "HR_FEEDBACK",
        ),
        (
            "Performance Warning",
            "Please ensure punctuality for morning standup meetings.",
            "WARNING",
        ),
        (
            "Company Announcement",
            "New company policy guidelines have been published.",
            "ANNOUNCEMENT",
        ),
        (
            "Profile Update",
